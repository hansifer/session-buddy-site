...
description: Updated February 11, 2026
interimVisible: true
---
...
Session Buddy collects anonymized usage metrics to maintain and improve performance, reliability, and user experience. Data collected is limited to:

- **Installation date:** when Session Buddy was installed
- **Installation ID:** a random number assigned to the Session Buddy install
- **SB version:** the current version of Session Buddy
- **Browser:** the browser vendor and major version (eg, Chrome 140)
- **Last access:** when Session Buddy was last opened
- **Collection count:** the total number of collections saved
- **Event count:** the total number of events saved

Usage data does not include the contents of saved collections or events, browsing history, tab URLs, search queries, or any personally identifiable information. All usage statistics are processed in aggregate form and used solely for product improvement, troubleshooting, and performance monitoring purposes. No usage data is transferred or sold to any third parties.

To opt out of sharing anonymous usage statistics:

1. Open Session Buddy
2. Click the gear menu
3. Select Settings
4. In the Settings dialog, select the General tab
5. Uncheck the "Share anonymous usage statistics" checkbox

### Support Requests

When you contact us with a support request, we may ask for information to aid in our troubleshooting efforts. This might include [diagnostics](https://sessionbuddy.com/diagnostics/) or the [Session Buddy data folders](https://sessionbuddy.com/data-location-v4/) residing on your device. We can only access this data if you explicitly send it to us.
...
Session Buddy does not transmit or store your collections, history, or settings to any external services. This data is stored locally on your device only.
...
You can export collections in a variety of formats or back up your collections and history for safe-keeping. See: [Import and Export](https://sessionbuddy.com/import-export/), [Backup and Restore](https://sessionbuddy.com/backup-restore/), or [Back Up and Restore Local Data](https://sessionbuddy.com/backup-restore-advanced/).
...
No longer in use. This permission was once used to display a "Current session saved" notification when saving a collection via the browser's web page context menu.

This permission has never been used to display any notifications not directly related to the functions of Session Buddy.
...
By default, Session Buddy cannot open incognito or local file links (links that have URLs starting with _file:///_). To enable this, you must opt into the appropriate permission on the extension settings page at `chrome://extensions/?id=edacconmaakjimmfgnblocblbcdcpbko`. See [Tab Open Permissions](https://sessionbuddy.com/tab-open-permissions/) for details.

## Chrome Web Store Privacy Disclosures

[Session Buddy's Chrome Web Store profile](https://chromewebstore.google.com/detail/session-buddy/edacconmaakjimmfgnblocblbcdcpbko) declares the handling of four categories of information.
...
We have to include this category because we provide a way for users to [send us donations](https://sessionbuddy.com/donate/).
...
If you have any questions or concerns about this privacy policy or our practices, please contact us at support@sessionbuddy.com.
