...
- IndexedDB errors in [the console](/console/) during startup or operation
...
1. **Save Data**: Open the Session Buddy [console](/console/) and execute the following [command](/console#console-commands):
...
2. **Save Diagnostics**: In the [console](/console/), execute the following [command](/console#console-commands):

`saveDiagnostics()`

This creates a download file with information that can be used for troubleshooting.

[Send this file to support](mailto:support@sessionbuddy.com) along with a description of what happened and any errors presented in the [console](/console/).
