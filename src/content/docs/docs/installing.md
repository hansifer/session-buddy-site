...
# Future support for other browsers

Dedicated versions for Edge, Firefox, and Brave are in development. In the meantime, the following browsers support Chrome Web Store extensions:

- Edge
- Brave
- ???

# Restoring data from a previous installation

After installing, you have the option to restore data from a previous installation.
