...
- A setting to **Enable single-click close and delete** has been added (under **Settings > General**). Enable this to allow tabs and links to once again be closed and deleted with a single click on the icon.
