...
slug: import-export
image: ../../../assets/images/import-export.svg
interimVisible: true
sidebar:
  order: 2
---
...
<div className="flex justify-center my-14!">
  <FeatureImage
    src={exportImg.src}
    alt="Session Buddy Export Dialog"
    shadow
    className="w-100"
  />
</div>
...
To enable various copy formats, go to Settings, select the "General" tab, and edit the list of "Copy As formats".
