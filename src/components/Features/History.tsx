  ...
  <section className="w-full">
    ...
    >
      <Feature
        ...
        description="Travel back in time to view and restore your tabs exactly as they were at a specific moment in the past."
        bullets={[
          'Recover open tabs after a browser crash or system restart.',
