...
- Windows and folders now also have checkbox selectors (or an “x” icon if **Enable single-click close and delete** is checked in **Settings > General**)
- Added a setting to auto-name new collections based on the current date and time (in **Settings > Collections**)
- Added a setting to always show tab and link counts next to windows and folders (in **Settings > General**)
- Added keyboard shortcut to **Clear tab/link selections** (to set up, go to **Settings > General > Open extension shortcuts**)
...
- Added diagnostic and data extract functions to facilitate support requests, troubleshooting, and recovery (available in **Settings > General** and the [Session Buddy console](/console/))
