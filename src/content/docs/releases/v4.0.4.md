...
- Added download fallback for lack of file selection support during Export. This primarily addresses Brave browser incompatibilities. See: [Troubleshooting export](https://sessionbuddy.com/troubleshooting-export/)
